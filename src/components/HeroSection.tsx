...
<div className='relative h-[130px] xxs:h-[150px] sm:h-[270px] md:h-[360px] xl:h-[450px] 2xl:h-[500px] rounded-2 overflow-hidden mt-2 md:mt-5 rounded-[8px] md:rounded-[8px] '>
